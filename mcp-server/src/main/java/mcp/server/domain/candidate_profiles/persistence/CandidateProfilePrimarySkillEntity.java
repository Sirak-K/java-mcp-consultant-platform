...
@Entity
@Table(name = "cand_profile_skills_primary", schema = "consultant_platform", uniqueConstraints = {
                @UniqueConstraint(name = "uq_cand_profile_primary_skill_number", columnNames = { "cand_profile_id",
                                "skill_number" }),
                @UniqueConstraint(name = "uq_cand_profile_primary_skill_id", columnNames = { "cand_profile_id",
                                "primary_skill_id" })
}, indexes = {
                @Index(name = "idx_cand_profile_skills_primary_profile_id", columnList = "cand_profile_id"),
                @Index(name = "idx_cand_profile_skills_primary_skill_id", columnList = "primary_skill_id")
})
public class CandidateProfilePrimarySkillEntity {

        @Id
        @GeneratedValue(strategy = GenerationType.IDENTITY)
        @Column(name = "cand_profile_primary_skill_id")
        private Long id;
        ...
        @JoinColumn(name = "cand_profile_id", nullable = false, foreignKey = @ForeignKey(name = "fk_cand_profile_primary_skill_profile"))
        ...
        protected CandidateProfilePrimarySkillEntity() {
        }

        public CandidateProfilePrimarySkillEntity(
                        Long id,
                        Integer skillNumber,
                        Long skillId,
                        String skillTitle,
