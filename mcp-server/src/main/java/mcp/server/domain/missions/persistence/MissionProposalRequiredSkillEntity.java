...
@Entity
@Table(name = "mission_proposal_slot_required_skill", schema = "consultant_platform", uniqueConstraints = {
        @UniqueConstraint(columnNames = { "mission_proposal_slot_id", "primary_skill_id" })
})
public class MissionProposalRequiredSkillEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "mission_proposal_slot_required_skill_id")
    private Long id;
    ...
    protected MissionProposalRequiredSkillEntity() {
    }

    public MissionProposalRequiredSkillEntity(
            Long id,
            Long skillId,
